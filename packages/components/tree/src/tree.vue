 ...
 * @LastEditTime: 2024-11-29 07:39:10
...
<template>
  <div :class="bem.b()">
    ...
    <z-tree-node v-for="node in flattenTree" :key="node.key" :node="node" :expanded="isExpanded(node)" @toggle="toggleExpanded"></z-tree-node>
  </div>
</template>
